...
class NhifOutpatientCsScraper(Scraper):
    ...
    def __init__(self):
        ...
        self.s3_key = "data/nhif_outpatient_cs_.json"
        self.s3_historical_record_key = "data/archive/nhif_outpatient_cs_-{}.json"
        self.delete_file = "data/delete_nhif_outpatient_cs_.json"
